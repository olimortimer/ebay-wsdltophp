...
/**
 * This class stands for AddItemResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: If the new listing is created successfully, the <b>AddItem</b> response includes the unique identifier of the new listing (<b>ItemID</b>) and the estimated values of any fees (such as insertion fee and any other listing upgrade fees)
 * generated as a result of the listing being created. <br/><br/> Other response fields include the the start and end times of the listing, and any other applicable fields such as the product SKU (if defined by seller), listing recommendations (if
 * applicable), or other details.
 * @subpackage Structs
 */
class AddItemResponseType extends AbstractResponseType
{
     ...
     * container reflects the currency used for the listing site, and not necessarily in the seller's default/home currency. For example, if a Canadian seller is using the <b>AddItem</b> call to list an item on the eBay US site, the currency type shown for
     * each fee will be <code>USD</code> and not <code>CAD</code>. </span>
     * - minOccurs: 0
     ...
     * <b>IncludeRecommendations</b> flag was included and set to 'true' in the <b>AddItem</b> request, and if at least one listing recommendation exists for the newly created listing. If one or more listing recommendations are returned, it will be at the
    ...
    /**
     * Constructor method for AddItemResponseType
     * @uses AddItemResponseType::setItemID()
     * @uses AddItemResponseType::setStartTime()
     * @uses AddItemResponseType::setEndTime()
     * @uses AddItemResponseType::setFees()
     * @uses AddItemResponseType::setCategoryID()
     * @uses AddItemResponseType::setCategory2ID()
     * @uses AddItemResponseType::setDiscountReason()
     * @uses AddItemResponseType::setProductSuggestions()
     * @uses AddItemResponseType::setListingRecommendations()
     * @param string $itemID
     ...
     */
    public function __construct($itemID = null, $startTime = null, $endTime = null, \StructType\FeesType $fees = null, $categoryID = null, $category2ID = null, array $discountReason = array(), \StructType\ProductSuggestionsType $productSuggestions = null, \StructType\ListingRecommendationsType $listingRecommendations = null)
    {
        $this
            ->setItemID($itemID)
     ...
     * Set ItemID value
     * @param string $itemID
     * @return \StructType\AddItemResponseType
     */
    ...
    public static function validateDiscountReasonForArrayConstraintsFromSetDiscountReason(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $addItemResponseTypeDiscountReasonItem) {
            // validation for constraint: enumeration
            if (!\EnumType\DiscountReasonCodeType::valueIsValid($addItemResponseTypeDiscountReasonItem)) {
                $invalidValues[] = is_object($addItemResponseTypeDiscountReasonItem) ? get_class($addItemResponseTypeDiscountReasonItem) : sprintf('%s(%s)', gettype($addItemResponseTypeDiscountReasonItem), var_export($addItemResponseTypeDiscountReasonItem, true));
            }
        }
