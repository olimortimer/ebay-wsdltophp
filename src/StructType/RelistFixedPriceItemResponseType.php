...
class RelistFixedPriceItemResponseType extends AbstractResponseType
{
     ...
     * <b>IncludeRecommendations</b> flag was included and set to 'true' in the <b>RelistFixedPriceItem</b> request, and if at least one listing recommendation exists for the newly relisted item. If one or more listing recommendations are returned, it will
