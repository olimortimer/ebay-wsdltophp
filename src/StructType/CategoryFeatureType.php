...
class CategoryFeatureType extends AbstractStructBase
{
    ...
    public static function validateListingDurationForArrayConstraintsFromSetListingDuration(array $values = array())
    {
        ...
        foreach ($values as $categoryFeatureTypeListingDurationItem) {
            ...
            if (!$categoryFeatureTypeListingDurationItem instanceof \StructType\ListingDurationReferenceType) {
    ...
    public static function validatePaymentMethodForArrayConstraintsFromSetPaymentMethod(array $values = array())
    {
        ...
        foreach ($values as $categoryFeatureTypePaymentMethodItem) {
            // validation for constraint: enumeration
            if (!\EnumType\BuyerPaymentMethodCodeType::valueIsValid($categoryFeatureTypePaymentMethodItem)) {
